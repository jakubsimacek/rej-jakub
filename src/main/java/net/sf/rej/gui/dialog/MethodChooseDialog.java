...
public class MethodChooseDialog extends JDialog {
    ...
    private DefaultComboBoxModel<Wrapper<Method>> methodModel = new DefaultComboBoxModel<>();
    JComboBox<ClassLocator> cls = new JComboBox<>(this.clsModel);
    private JButton clsButton = new JButton(this.classChooserAction);
    private JComboBox<Wrapper<Method>> method = new JComboBox<>(this.methodModel);

...
public class FieldChooseDialog extends JDialog {
    ...
    DefaultComboBoxModel<ClassLocator> clsModel = new DefaultComboBoxModel<>();
    private DefaultComboBoxModel<Wrapper<Field>> fieldModel = new DefaultComboBoxModel<>();
    JComboBox<ClassLocator> cls = new JComboBox<>(this.clsModel);
    private JButton clsButton = new JButton(this.classChooserAction);
    private JComboBox<Wrapper<Field>> field = new JComboBox<>(this.fieldModel);
    ...
    public void done() {
		...
		Wrapper<Field> wrapper = (Wrapper<Field>) this.field.getSelectedItem();
        if(wrapper != null) {

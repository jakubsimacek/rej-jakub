...
public class DoubleInfoTest extends TestCase {
	...
	public final void testGetData() {
		...
		try {
			assertTrue("0", Arrays.equals(expected, data));
		...
		try {
			assertTrue("19", Arrays.equals(expected, data));
		} catch(AssertionError ae) {
			System.out.println("Expected: " + ByteToolkit.byteArrayToDebugString(expected));
			System.out.println("Result: " + ByteToolkit.byteArrayToDebugString(data));
			throw ae;
		...
		try {
			assertTrue("258", Arrays.equals(expected, data));
		} catch(AssertionError ae) {
			System.out.println("Expected: " + ByteToolkit.byteArrayToDebugString(expected));
			System.out.println("Result: " + ByteToolkit.byteArrayToDebugString(data));
			throw ae;
	...
	public final void testGetTypeString() {
		...
		assertEquals("type string", "Double constant", di.getTypeString());
	}
	...
	public final void testDoubleInfoIntConstantPool() {
		DoubleInfo di = new DoubleInfo(0, 0, new ConstantPool());
		assertEquals("0 high bytes", 0l, di.getHighBytes());
		assertEquals("0 low bytes", 0l, di.getLowBytes());
		di = new DoubleInfo(0, 1, new ConstantPool());
		assertEquals("0 high bytes", 0l, di.getHighBytes());
		assertEquals("1 low bytes", 1l, di.getLowBytes());
		di = new DoubleInfo(2, 1, new ConstantPool());
		assertEquals("2 high bytes", 2l, di.getHighBytes());
		assertEquals("1 low bytes", 1l, di.getLowBytes());
	}
	...
	public final void testDoubleInfoDoubleConstantPool() {
		...
		assertEquals("0.0d", 0.0d, di.getDoubleValue());
		di = new DoubleInfo(1.1d, new ConstantPool());
		assertEquals("1.1d", 1.1d, di.getDoubleValue());
		di = new DoubleInfo(-1.1d, new ConstantPool());
		assertEquals("-1.1d", -1.1d, di.getDoubleValue());
	}
	...
	public final void testEqualsObject() {
		...
		assertTrue("both zero a.equals(b)", a.equals(b));
		assertTrue("both zero b.equals(a)", b.equals(a));
		
		b.setDoubleValue(1f);
		assertFalse("a=0, b=1 a.equals(b)", a.equals(b));
		assertFalse("a=0, b=1 b.equals(a)", b.equals(a));
		
		a.setDoubleValue(Double.NaN);
		assertFalse("a=NaN, b=1 a.equals(b)", a.equals(b));
		assertFalse("a=NaN, b=1 b.equals(a)", b.equals(a));

		b.setDoubleValue(Double.NaN);
		assertTrue("a=NaN, b=NaN a.equals(b)", a.equals(b));
		assertTrue("a=NaN, b=NaN b.equals(a)", b.equals(a));

		a.setDoubleValue(Double.POSITIVE_INFINITY);
		assertFalse("a=positive inf, b=NaN a.equals(b)", a.equals(b));
		assertFalse("a=positive inf, b=NaN b.equals(a)", b.equals(a));

		b.setDoubleValue(3.5d);
		a.setDoubleValue(Double.NEGATIVE_INFINITY);
		assertFalse("a=negative inf, b=3.5d a.equals(b)", a.equals(b));
		assertFalse("a=negative inf, b=3.5d b.equals(a)", b.equals(a));

		b.setDoubleValue(3.5d);
		a.setDoubleValue(3.5d);
		assertTrue("a=3.5d, b=3.5d a.equals(b)", a.equals(b));
		assertTrue("a=3.5d, b=3.5d b.equals(a)", b.equals(a));

		a.setDoubleValue(-3.5d);
		assertFalse("a=-3.5d, b=3.5d a.equals(b)", a.equals(b));
		assertFalse("a=-3.5d, b=3.5d b.equals(a)", b.equals(a));
	}
	...
	public final void testGetDoubleValue() {
		...
		assertEquals("1.0d", 1.0d, di.getDoubleValue());
		di = new DoubleInfo(0.0d, cp);
		assertEquals("0.0d", 0.0d, di.getDoubleValue());
		di = new DoubleInfo(-1.0d, cp);
		assertEquals("-1.0d", -1.0d, di.getDoubleValue());
		di = new DoubleInfo(618.8d, cp);
		assertEquals("618.8d", 618.8d, di.getDoubleValue());
		di = new DoubleInfo(Double.NEGATIVE_INFINITY, cp);
		assertEquals("negative indinity", Double.NEGATIVE_INFINITY, di.getDoubleValue());
		di = new DoubleInfo(Double.POSITIVE_INFINITY, cp);
		assertEquals("positive indinity", Double.POSITIVE_INFINITY, di.getDoubleValue());
		di = new DoubleInfo(Double.NaN, cp);
		assertEquals("not a number", Double.NaN, di.getDoubleValue());
	}
